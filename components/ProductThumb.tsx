...
function ProductThumb({product}: {product: Product }){
    ...
    return (
        ...
        border-gray-200 shadow-sm hover:shadow-md transition-all
        ...
        >
            ...
            h-full overflow-hidden">
                {product.mainImage && (
                    ...
                    src={urlFor(product.mainImage)?.toString() || ''}
                    alt={product.mainImage.alt || product.name || "Product Name"}
                    fill
                ...
                {isOutOfStock && (
                    ...
                    bg-black bg-opacity-50">
                        ...
                        font-bold text-lg">Out of Stock</span>
                    </div>
                )}
            </div> 
            <div className="p-4">
